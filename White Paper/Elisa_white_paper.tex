...
\newcommand{\commentJK}[2][1=]{\todo[linecolor=red,backgroundcolor=red!25,bordercolor=red,#1]{JK: #2}}
\newcommand{\commentJM}[2][1=]{\todo[linecolor=blue,backgroundcolor=blue!25,bordercolor=blue,#1]{JM: #2}}
\begin{document}
